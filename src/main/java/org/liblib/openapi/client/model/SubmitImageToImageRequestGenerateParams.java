...
public class SubmitImageToImageRequestGenerateParams {
  ...
  public SubmitImageToImageRequestGenerateParams() {
  }

  public SubmitImageToImageRequestGenerateParams checkPointId(@javax.annotation.Nullable String checkPointId) {
  ...
  public SubmitImageToImageRequestGenerateParams prompt(@javax.annotation.Nullable String prompt) {
    this.prompt = prompt;
    return this;
  }
  ...
  public SubmitImageToImageRequestGenerateParams negativePrompt(@javax.annotation.Nullable String negativePrompt) {
  ...
  public SubmitImageToImageRequestGenerateParams clipSkip(@javax.annotation.Nullable Integer clipSkip) {
  ...
  public SubmitImageToImageRequestGenerateParams sampler(@javax.annotation.Nullable Integer sampler) {
  ...
  public SubmitImageToImageRequestGenerateParams steps(@javax.annotation.Nullable Integer steps) {
    this.steps = steps;
    return this;
  }
  ...
  public SubmitImageToImageRequestGenerateParams cfgScale(@javax.annotation.Nullable Integer cfgScale) {
  ...
  public SubmitImageToImageRequestGenerateParams randnSource(@javax.annotation.Nullable Integer randnSource) {
  ...
  public SubmitImageToImageRequestGenerateParams seed(@javax.annotation.Nullable Integer seed) {
    this.seed = seed;
    return this;
  }
  ...
  public SubmitImageToImageRequestGenerateParams imgCount(@javax.annotation.Nullable Integer imgCount) {
  ...
  public SubmitImageToImageRequestGenerateParams restoreFaces(@javax.annotation.Nullable Integer restoreFaces) {
  ...
  public SubmitImageToImageRequestGenerateParams sourceImage(@javax.annotation.Nullable String sourceImage) {
  ...
  public SubmitImageToImageRequestGenerateParams resizeMode(@javax.annotation.Nullable Integer resizeMode) {
  ...
  public SubmitImageToImageRequestGenerateParams resizedWidth(@javax.annotation.Nullable Integer resizedWidth) {
  ...
  public SubmitImageToImageRequestGenerateParams resizedHeight(@javax.annotation.Nullable Integer resizedHeight) {
  ...
  public SubmitImageToImageRequestGenerateParams mode(@javax.annotation.Nullable Integer mode) {
    this.mode = mode;
    return this;
  }
  ...
  public SubmitImageToImageRequestGenerateParams denoisingStrength(@javax.annotation.Nullable Float denoisingStrength) {
  ...
  public SubmitImageToImageRequestGenerateParams additionalNetwork(@javax.annotation.Nullable List<AdditionalNetwork> additionalNetwork) {
    this.additionalNetwork = additionalNetwork;
    return this;
  }

  public SubmitImageToImageRequestGenerateParams addAdditionalNetworkItem(AdditionalNetwork additionalNetworkItem) {
  ...
  public SubmitImageToImageRequestGenerateParams controlNet(@javax.annotation.Nullable List<ControlNet> controlNet) {
    this.controlNet = controlNet;
    return this;
  }

  public SubmitImageToImageRequestGenerateParams addControlNetItem(ControlNet controlNetItem) {
  ...
  public boolean equals(Object o) {
    ...
    SubmitImageToImageRequestGenerateParams submitImageToImageRequestGenerateParams = (SubmitImageToImageRequestGenerateParams) o;
    return Objects.equals(this.checkPointId, submitImageToImageRequestGenerateParams.checkPointId) &&
        Objects.equals(this.prompt, submitImageToImageRequestGenerateParams.prompt) &&
        Objects.equals(this.negativePrompt, submitImageToImageRequestGenerateParams.negativePrompt) &&
        Objects.equals(this.clipSkip, submitImageToImageRequestGenerateParams.clipSkip) &&
        Objects.equals(this.sampler, submitImageToImageRequestGenerateParams.sampler) &&
        Objects.equals(this.steps, submitImageToImageRequestGenerateParams.steps) &&
        Objects.equals(this.cfgScale, submitImageToImageRequestGenerateParams.cfgScale) &&
        Objects.equals(this.randnSource, submitImageToImageRequestGenerateParams.randnSource) &&
        Objects.equals(this.seed, submitImageToImageRequestGenerateParams.seed) &&
        Objects.equals(this.imgCount, submitImageToImageRequestGenerateParams.imgCount) &&
        Objects.equals(this.restoreFaces, submitImageToImageRequestGenerateParams.restoreFaces) &&
        Objects.equals(this.sourceImage, submitImageToImageRequestGenerateParams.sourceImage) &&
        Objects.equals(this.resizeMode, submitImageToImageRequestGenerateParams.resizeMode) &&
        Objects.equals(this.resizedWidth, submitImageToImageRequestGenerateParams.resizedWidth) &&
        Objects.equals(this.resizedHeight, submitImageToImageRequestGenerateParams.resizedHeight) &&
        Objects.equals(this.mode, submitImageToImageRequestGenerateParams.mode) &&
        Objects.equals(this.denoisingStrength, submitImageToImageRequestGenerateParams.denoisingStrength) &&
        Objects.equals(this.additionalNetwork, submitImageToImageRequestGenerateParams.additionalNetwork) &&
        Objects.equals(this.controlNet, submitImageToImageRequestGenerateParams.controlNet);
  }
  ...
  public String toString() {
    ...
    sb.append("class SubmitImageToImageRequestGenerateParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SubmitImageToImageRequestGenerateParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SubmitImageToImageRequestGenerateParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SubmitImageToImageRequestGenerateParams is not found in the empty JSON string", SubmitImageToImageRequestGenerateParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SubmitImageToImageRequestGenerateParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SubmitImageToImageRequestGenerateParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SubmitImageToImageRequestGenerateParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SubmitImageToImageRequestGenerateParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SubmitImageToImageRequestGenerateParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SubmitImageToImageRequestGenerateParams.class));

       return (TypeAdapter<T>) new TypeAdapter<SubmitImageToImageRequestGenerateParams>() {
           @Override
           public void write(JsonWriter out, SubmitImageToImageRequestGenerateParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SubmitImageToImageRequestGenerateParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SubmitImageToImageRequestGenerateParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SubmitImageToImageRequestGenerateParams
   * @throws IOException if the JSON string is invalid with respect to SubmitImageToImageRequestGenerateParams
   */
  public static SubmitImageToImageRequestGenerateParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SubmitImageToImageRequestGenerateParams.class);
  }

  /**
   * Convert an instance of SubmitImageToImageRequestGenerateParams to an JSON string
   *
   * @return JSON string
   */
