...
import cloud.liblibai.openapi.client.auth.Authentication;
import cloud.liblibai.openapi.client.auth.HttpBasicAuth;
import cloud.liblibai.openapi.client.auth.HttpBearerAuth;
import cloud.liblibai.openapi.client.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://openapi.liblibai.cloud";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://openapi.liblibai.cloud",
      "LiblibAI Open Platform",
    ...
    public ApiClient() {
        ...
        authentications.put("ApiKeyAuth", new ApiKeyAuth("query", "AccessKey"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://openapi.liblibai.cloud
     ...
     * @return a {@link cloud.liblibai.openapi.client.ApiClient} object
     */
    ...
    */
     ...
     * @throws cloud.liblibai.openapi.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws cloud.liblibai.openapi.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws cloud.liblibai.openapi.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws cloud.liblibai.openapi.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws cloud.liblibai.openapi.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws cloud.liblibai.openapi.client.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws cloud.liblibai.openapi.client.ApiException If fails to update the parameters
     */
     ...
     * @throws cloud.liblibai.openapi.client.ApiException If fail to serialize the request body object into a string
     */
